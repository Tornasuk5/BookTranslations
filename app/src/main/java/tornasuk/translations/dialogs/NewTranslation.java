                            ...
                            if(novel != null){
                                for(DataSnapshot transSnapshot : snapshot.child(novel).child(volume).getChildren()){
                                    if(!transSnapshot.getKey().equals("volImg")){
                                        ...
                                        else if(idPgTranslation[0].equals(StaticVariables.refID + numPag))
                                            count++;
                                    }
                                }
                                id = StaticVariables.refID + numPag + "-" + (count);
                                ...
                                String generalTheme = Utils.getThemeFromID(StaticVariables.refID);
                                int numIdMax = 0;
                                ...
                                id = StaticVariables.refID + "-" + (numIdMax + 1);
