            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                translationsAdapter.setOnClickListener(v -> {
                    ...
                    if (novel == null) {
                        ...
                        else if (translation.getId().split("-")[0].equals(Constantes.ID_KOICHOCO))
                            Navigation.findNavController(requireActivity(), R.id.nav_host_frag).navigate(R.id.nav_koichoco);
                        else
