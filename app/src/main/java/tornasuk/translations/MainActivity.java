...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        switch (fragTag) {
            case "General":
                StaticVariables.refID = Constantes.ID_GENERAL;
                icon.setIcon(R.drawable.icon_general);
                break;
            case "Clannad ~After Story~":
                StaticVariables.refID = Constantes.ID_CLANNAD;
                icon.setIcon(R.drawable.icon_clannad);
                break;
            case "Koichoco":
                StaticVariables.refID = Constantes.ID_KOICHOCO;
                icon.setIcon(R.drawable.choco);
                break;
            case "Overlord":
                StaticVariables.refID = Constantes.ID_OVERLORD;
